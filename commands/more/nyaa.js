    ...
    CmdUtils.CreateCommand(
        {
            ...
            timeout: 1000,
            /*---------------------------------------------------------------------------*/
            description: "Search for anime and JAV releases.",
            help: `Syntax: <b>nyaa</b> <i>release title</i> <b>in</b> <i>list</i><br>
                   Available <i>list</i>s: anime, JAV`,
            /*---------------------------------------------------------------------------*/
            ...
            _perform_check: function (pblock, movie_id, server) {
                ...
                let self = this;
                let id_encoded = encodeURIComponent(movie_id.trim());
